...
const session_cookie_name = 'consultorio-token';
const user_email_cookie_name = 'consultorio-email';
const user_id_cookie_name = 'consultorio-user_id';
const user_complete_name_cookie_name = 'consultorio-user_complete_name';
const group_name_cookie_name = 'consultorio-group_name';
const codigo_cookie_name = 'consultorio-codigo';
...
export class FacadeService {
  ...
  saveUserData(user_data: any) { // Guardar cada uno de los valores cuando es PACIENTE
    //console.log("Saving user data:", user_data);
    var secure = environment.url_api.indexOf("https") != -1;
    if (user_data.rol == "paciente") { // TODO: pacienteS
      ...
      this.cookieService.set(user_id_cookie_name, user_data.id, undefined, undefined, undefined, secure, secure ? "None" : "Lax"); // TODO: aqui le quite el .user
